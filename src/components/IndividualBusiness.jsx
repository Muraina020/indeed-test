...
const IndividualBusiness = () => {
  return (
    <div className='flex flex-col gap-3 p-[50px] items-center justify-center'>
        <h1 className='text-5xl font-bold text-green-900'>For Individual and Businesses</h1>
        <p className='text-xl text-gray-800 font-semibold py-4'>Join 200+ businesses using Eazipay's easy solution</p>
        <div className='flex flex-row shadow-transparent '>
            ...
            <div className='bg-green-900 p-10 w-[350px] text-white inset shadow-green-950 shadow-inner rounded-md'>
           ...
           <p className='text-[14px] text-green-950 w-[400px] mt-4'>We are happy to answer your queries. Please reach us at<span className='text-red-500 text-[14px]'>hello@myeasypay.com</span> and expect our response shortly later</p>
    </div>
  )
}
