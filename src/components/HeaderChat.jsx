...
<div className='w-[20%] h-[15%%] relative'>
        ...
        <div className="self-stretch flex flex-col items-start justify-start gap-[20px] ml-[200px]">

          <div className="self-stretch flex flex-col items-start justify-start gap-[5px] w-[300px] h-[350px]">


            <div className="self-stretch flex flex-col items-start justify-center gap-[4px]">
              <div className="flex flex-row items-start justify-start">
                <b className="relative text-[28px]">Welcome Abasiama</b>
              </div>
              <div className="relative text-base text-[18px] font-medium text-black">
                Pay and manage your employee in minutes
              </div>
            </div>


            <div className="flex flex-row items-start justify-start gap-[10px] text-white">
              <div className="flex flex-col items-start justify-start gap-[10px]">
                <div className="flex-1 rounded-3xl bg-green-900 shadow-inner w-[600px] overflow-hidden flex flex-col py-[10px] px-6 items-start justify-center relative gap-[10px] border-[1px] border-solid border-gray-500">
                  ...
                  <div className="self-stretch flex flex-row items-end justify-between z-[0]">
                    <div className="flex flex-col items-start justify-start gap-[8px]">
                      ...
                      <div className="flex flex-row items-center justify-start gap-[8px] text-5xl text-white">
                        <div className="flex flex-row items-start justify-start">
                          <b className="relative text-[25px]">
                            N12,560,078.00
                          </b>
                        </div>
                    ...
                    <div className="rounded-3xl bg-green-300 shadow-inner flex flex-row py-2 px-5 items-center justify-center text-sm text-new-styles-primary-eazi-green">
                ...
                <div className="self-stretch rounded-3xl flex flex-row items-center justify-start gap-[8px] text-center text-sm text-zinc-500">
                  <div className="flex-1 rounded-3xl bg-white shadow-inner flex flex-col py-2 px-4 items-center justify-start gap-[10px] border-[1px] border-solid border-gray-300">
                    <img
                      className="relative rounded-xl w-10 h-10 bg-red-50 "
                      alt=""
                      src={user}
                    />
                  ...
                  <div className="flex-1 rounded-3xl bg-white shadow-inner flex flex-col py-2 px-4 items-center justify-start gap-[10px] border-[1px] border-solid border-zinc-300">
                    <img
                      className="relative rounded-xl w-10 h-10"
                      alt=""
                      src={upwork}
                  ...
                  <div className="flex-1 rounded-3xl bg-white shadow-transparent flex flex-col p-2 px-4 items-center justify-start gap-[10px] border-[1px] border-solid border-zinc-300">
                    <img
                      className="relative rounded-xl w-10 h-10"
                      alt=""
                      src={hand}
            ...
            {/* <div className="self-stretch rounded-3xl bg-white shadow-zinc-300 box-border w-[190px] overflow-hidden shrink-0 flex flex-col pt-0 px-4 pb-4 items-center justify-between text-center tex  t-new-styles-text-body-dark border-[1px] border-solid border-zinc-300">
          ...
          <div className="rounded-3xl box-border w-[600px] h-[175px] flex flex-col items-center justify-center text-base text-black border-[1px] border-solid border-inner">
            <div className="self-stretch rounded-2xl bg-white shadow-transparent flex flex-col p-[10px] items-center justify-center relative gap-[9px]">
              ...
              <div className="self-stretch h-[77px] flex flex-row items-start justify-between z-[0]">
                <div className="flex flex-col items-start justify-center gap-[2px]">
                  ...
                  <b className="relative text-xl leading-[36px] text-green-800">
                    N1,567,552
                  </b>
                </div>
                <div className="flex flex-col items-start justify-center gap-[4px]">
                  ...
                  <b className="relative text-xl leading-[36px] text-red-500">
                    N1,567,552
                  </b>
                </div>
                <div className="flex flex-row items-center justify-start gap-[20px] text-sm text-gray">
              ...
              <div className="self-stretch h-[295px] flex flex-col py-0 px-12 box-border items-start justify-center gap-[9px] z-[1] text-xs text-new-styles-text-body-normal">
                <div className="w-[734px] flex flex-row items-center justify-start gap-[12px]">
                  ...
                  <div className="relative w-[686px] h-[250px] text-white">
                ...
                <div className="w-[600px] flex flex-row py-0 pr-0 pl-4 box-border items-center justify-start gap-[20px]">
      ...
      <div className="absolute top-[80px] left-[0px] bg-white w-[185px] h-[500px] overflow-hidden">
        <img
          className="absolute top-[0px] left-[0px] w-[318.28px] h-[100.7px]"
          alt=""
          src={azi}
        />
        <div className="absolute top-[100px] left-[0px] w-[272px] h-[400px] overflow-hidden">
          <div className="absolute top-[px] left-[0px] flex flex-col items-center justify-start gap-[14px]">
            <div className="flex flex-col items-center justify-start">
              <div className="relative box-border w-[272px] h-10 overflow-hidden shrink-0 border-b-[0.8px] border-solid">
                <div className="absolute top-[10px] left-[10px] flex flex-row items-center justify-start gap-[8px]">
                  <img
              ...
              <div className="relative bg-old-styles-white-color box-border w-[272px] h-10 overflow-hidden shrink-0 border-b-[0.8px] border-solid border-new-styles-grays-outline">
                <div className="absolute top-[10px] left-[10px] flex flex-row items-center justify-start gap-[8px]">
                  <img
              ...
              <div className="relative bg-old-styles-white-color box-border w-[272px] h-10 overflow-hidden shrink-0 border-b-[0.8px] border-solid border-new-styles-grays-outline">
                <div className="absolute top-[10px] left-[10px] flex flex-row items-center justify-start gap-[12px]">
                  <img
                    className="relative w-5 h-5"
                    alt=""
                    src={setting}
